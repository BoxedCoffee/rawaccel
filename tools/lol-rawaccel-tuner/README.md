...
## Fix weak bins
`Fix weak bins` runs a paired before/after test on your selected bins:

1. Baseline focus rounds
2. Proposes a small tweak (AI if configured, otherwise heuristic)
3. Re-tests the same bins with the same seeds

It then reports a winner and shows baseline vs tweak directional tables.
